...
const String TITEL1 = "Ardu";                                 // Titelbildschirm: Kleingedruckte erste Titelzeile
const String TITEL2 = "BOYNG";                                // Titelbildschirm: Großgedruckte zweite Titelzeile
